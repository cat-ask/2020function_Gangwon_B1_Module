class App{
    ...
    make_graph(list){
        ...
        for(let k = 0; k < 7; k++){
            ...
            ctx.fillRect(x,canvas_Ystart + arc,val_width,4 * canvas_Ystep + canvas_Ystep / 2 - 8.5);
            ...
            ctx.beginPath();
            ctx.arc(x + val_width / 2 ,y ,arc - 7,x,x + val_width);
            ctx.fill();
            ...
            ctx.fillStyle = color;
            ctx.fillText(val_text,(x + val_width / 2) - (val_text.length * 5 / 2) ,y + 3);
        }
    ...
    async buyer_infor_form_popup(){
        ...
        let content = `<form id="buyer_info_form">
                            ...
                            <div class="form-control">
                                ...
                                <input type="text" id="buyer_name" data-column="구매자명" name="buyer_name" class="form-input">
                            </div>
                            <div class="form-control">
                                <div class="form-header">
                                ...
                                <input type="text" id="buyer_phone" data-column="전화번호" name="buyer_phone" class="form-input">
                            </div>
                            <div class="form-control">
                                <div class="form-header">
                                ...
                                <input type="text" id="buyer_zip_code" data-column="우편번호" name="buyer_zip_code" class="form-input">
                            </div>
                            <div class="form-control">
                                <div class="form-header">
                                ...
                                <input type="text" id="buyer_address" data-column="주소" name="buyer_address" class="form-input">
                            </div>
                            <div class="form-control">
                                <div class="form-header">
                                ...
                                <input type="text" id="buyer_detail_address" data-column="상세주소" name="buyer_detail_address" class="form-input">
                            </div>
                        </form>
    ...
    buyer_info_form_send(){
        document.querySelectorAll("#buyer_info_form .form-input").forEach(x=>{this.form_check(x)});
    ...
    form_check(target){
        ...
        else if(id === "delivery_date"){
            this.buy_list.forEach(x=>{
                if(x.delivery_date === val) document.querySelector(`#delivery_time > option[value='${x.delivery_time}']`).setAttribute("disabled",true);
                else document.querySelector(`#delivery_time > option[value='${x.delivery_time}']`).setAttribute("disabled",false);
            })
        }
